...
namespace Test_DictOfCompetition_WriteLog {
  ...
  void UnitTest_DictBacking_DictOfCompetition_WriteLog() {
    ...
    assert(38*2 == countFileLines(IO::FromDataFolder('Storage/codegenTest/test/DictOfCompetition_WriteLog.txt')), "Should have written exactly 38*2 lines to the log.");
    ...
    assert(38 == testDict.GetSize(), 'Init size after reloading from disk, was: ' + testDict.GetSize());
