...
namespace Test_DictOfUintToMatchResults_WriteLog {
  ...
  void UnitTest_DictBacking_DictOfUintToMatchResults_WriteLog() {
    ...
    assert(42*2 == countFileLines(IO::FromDataFolder('Storage/codegenTest/test/DictOfUintToMatchResults_WriteLog.txt')), "Should have written exactly 42*2 lines to the log.");
