...
namespace Test_DictOfTrackOfTheDayEntry_WriteLog {
  ...
  void UnitTest_DictBacking_DictOfTrackOfTheDayEntry_WriteLog() {
    ...
    assert(39*2 == countFileLines(IO::FromDataFolder('Storage/codegenTest/test/DictOfTrackOfTheDayEntry_WriteLog.txt')), "Should have written exactly 39*2 lines to the log.");
    ...
    assert(39 == testDict.GetSize(), 'Init size after reloading from disk, was: ' + testDict.GetSize());
