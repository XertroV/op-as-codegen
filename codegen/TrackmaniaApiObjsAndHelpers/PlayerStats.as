shared class PlayerStats {
  ...
  PlayerStats(const string &in Name, const string &in SpawnStatus, const uint[] &in CurrentLapTimes, const uint[] &in CurrentRaceTimes, uint CurrentLapTime, uint CurrentRaceTime) {
    this._Name = Name;
